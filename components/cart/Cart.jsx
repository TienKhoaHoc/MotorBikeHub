...
const Cart = () => {
  ...
  const taxAmount = (amountWithoutTax * 0.02).toFixed(2);
                ...
                <article className="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                  <ul className="mb-5">
                    <li className="flex justify-between text-gray-600  mb-1">
                      <span>Tổng thanh toán trước thuế:</span>
                      <span>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(amountWithoutTax)}</span>
                    </li>
                    <li className="flex justify-between text-gray-600  mb-1">
                    ...
                    <li className="flex justify-between text-gray-600  mb-1">
                      <span>Thuế:</span>
                      <span>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(taxAmount)}</span>
                    </li>
