...
const Filters = () => {
  ...
  return (
    <aside className="md:w-1/3 lg:w-1/4 px-4">
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        <h3 className="font-semibold mb-2">Hãng Xe</h3>
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Honda"
                className="h-4 w-4"
                defaultChecked={checkHandler("brand", "honda")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Honda </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Yahama"
                className="h-4 w-4"
                defaultChecked={checkHandler("brand", "Yamaha")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Yahama </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Suzuki"
                className="h-4 w-4"
                defaultChecked={checkHandler("brand", "Suzuki")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Suzuki </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="SYM"
                className="h-4 w-4"
                defaultChecked={checkHandler("brand", "SYM")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> SYM </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Other"
                className="h-4 w-4"
                defaultChecked={checkHandler("brand", "Other")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Khác... </span>
            </label>
          </li>
        </ul>
