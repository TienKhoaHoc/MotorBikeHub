        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
            ...
            <main>
              ...
              <p className="mb-4 font-semibold text-xl">{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product?.price)}</p>


              <p className="mb-4 text-gray-500">{product?.decrip}</p>
              ...
              <ul className="mb-5">
                <li className="mb-1">
                  {" "}
                  <b className="font-medium w-36 inline-block">Số lượng</b>
                  {inStock ? (
